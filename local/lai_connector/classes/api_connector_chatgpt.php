...
// In this subclass we modually define all the nessessary elements to access the ChatGPT API.
use pix_icon;
use stdClass;
use moodle_url;

class api_connector_chatgpt
{
    // Still blank, for demonstration purposes only at this point!
