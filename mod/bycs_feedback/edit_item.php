...
if ($itemid) {
    ...
    $url = new moodle_url('/mod/bycs_feedback/edit_item.php', array('id' => $itemid));
    $typ = $item->typ;
} else {
    $item = null;
    list($course, $cm) = get_course_and_cm_from_cmid($cmid, 'feedback');
    $url = new moodle_url('/mod/bycs_feedback/edit_item.php', array('cmid' => $cm->id, 'typ' => $typ));
...
$editurl = new moodle_url('/mod/bycs_feedback/edit.php', array('id' => $cm->id));
...
navigation_node::override_active_url(new moodle_url('/mod/bycs_feedback/edit.php',
