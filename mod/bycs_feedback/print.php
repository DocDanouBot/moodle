...
$PAGE->set_url('/mod/bycs_feedback/print.php', array('id'=>$id));
...
$feedback_url = new moodle_url('/mod/bycs_feedback/index.php', array('id'=>$course->id));
...
$continueurl = new moodle_url('/mod/bycs_feedback/view.php', array('id' => $id));
if ($courseid) {
    $continueurl->param('courseid', $courseid);
}

$form = new mod_bycs_feedback_complete_form(mod_bycs_feedback_complete_form::MODE_PRINT,
