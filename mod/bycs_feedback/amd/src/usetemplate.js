 ...
 *
 * @module      mod_bycs_feedback/usetemplate
...
export const init = () => {
    ...
    trigger.addEventListener('click', event => {
        ...
        const modalForm = new ModalForm({
            modalConfig: {
                title: getString('use_this_template', 'mod_bycs_feedback'),
            },
            formClass: 'mod_bycs_feedback\\form\\use_template_form',
            args: {
        ...
        modalForm.addEventListener(modalForm.events.FORM_SUBMITTED, event => {
            if (event.detail.result) {
                ...
                Notification.addNotification({
                    type: 'error',
                    message:  getString('saving_failed', 'mod_bycs_feedback')
                });
            }
        });
