...
/**
 * Contains class mod_bycs_feedback_responses_table
 *
...
/**
 * Class mod_bycs_feedback_responses_table
 *
 * @package   mod_bycs_feedback
 * @copyright 2016 Marina Glancy
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_bycs_feedback_responses_table extends table_sql {
    ...
    /** @var mod_bycs_feedback_structure */
     ...
     * Constructor
     *
     * @param mod_bycs_feedback_structure $feedbackstructure
     * @param int $group retrieve only users from this group (optional)
     */
    public function __construct(mod_bycs_feedback_structure $feedbackstructure, $group = 0) {
        ...
        $this->define_baseurl(new moodle_url('/mod/bycs_feedback/show_entries.php',
    ...
    protected function add_all_values_to_output() {
        ...
        foreach ($items as $nr => $item) {
            ...
            if (strval($item->label) !== '') {
                $columnheader = get_string('nameandlabelformat', 'mod_bycs_feedback',
