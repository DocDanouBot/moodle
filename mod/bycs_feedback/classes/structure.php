...
/**
 * Contains class mod_bycs_feedback_structure
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_bycs_feedback_structure {
    ...
    public function __construct($feedback, $cm, $courseid = 0, $templateid = null, $userid = 0) {
        ...
        if (!$feedback) {
            ...
            // Full instance record can be retrieved by calling mod_bycs_feedback_structure::get_feedback().
    ...
    public function page_after_submit() {
        ...
        $output = file_rewrite_pluginfile_urls($pageaftersubmit,
                'pluginfile.php', $context->id, 'mod_bycs_feedback', 'page_after_submit', 0);
