...
/**
 * Contains class mod_bycs_feedback_templates_table
 *
...
/**
 * Class mod_bycs_feedback_templates_table
 *
 * @package   mod_bycs_feedback
 * @copyright 2016 Marina Glancy
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_bycs_feedback_templates_table extends flexible_table {
    ...
    public function display($templates) {
        ...
        foreach ($templates as $template) {
            ...
            if ($this->mode && has_capability('mod/feedback:deletetemplate', $this->get_context())) {
                $deleteurl = new moodle_url('/mod/bycs_feedback/manage_templates.php',
