...
namespace mod_bycs_feedback\output;
...
class edit_action_bar extends base_action_bar {
    ...
    public function get_items(): array {
        $url = new moodle_url('/mod/bycs_feedback/view.php', ['id' => $this->cmid]);
        ...
        if (has_capability('mod/feedback:edititems', $this->context)) {
            $editurl = new moodle_url('/mod/bycs_feedback/edit.php', $this->urlparams);
            $templateurl = new moodle_url('/mod/bycs_feedback/manage_templates.php', $this->urlparams);
            $importurl = new moodle_url('/mod/bycs_feedback/import.php', $this->urlparams);
            ...
            if ($this->currenturl->compare(new moodle_url('/mod/bycs_feedback/use_templ.php'), URL_MATCH_BASE)) {
            ...
            if ($viewquestions) {
                $select = new single_select(new moodle_url('/mod/bycs_feedback/edit_item.php',
                ...
                $exporturl = new moodle_url('/mod/bycs_feedback/export.php', $this->urlparams + ['action' => 'exportfile']);
