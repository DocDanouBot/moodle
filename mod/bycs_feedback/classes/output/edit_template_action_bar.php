...
class edit_template_action_bar extends base_action_bar {
    ...
    public function get_items(): array {
        ...
        $templateurl = new moodle_url('/mod/bycs_feedback/manage_templates.php', $this->urlparams + $additionalparams);
        ...
        if ($showdelete) {
            ...
            $deleteurl = new moodle_url('/mod/bycs_feedback/manage_templates.php', $params);
