...
/**
 * Contains class mod_bycs_feedback_completion
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_bycs_feedback_completion extends mod_bycs_feedback_structure {
    /** @var stdClass */
    protected $completed;
    /** @var stdClass */
    ...
    /** @var mod_bycs_feedback_complete_form the form used for completing the feedback */
    protected $form = null;
     ...
     *
     * @param stdClass $data data from the form mod_bycs_feedback_complete_form
     */
    ...
    public function trigger_module_viewed() {
        $event = \mod_bycs_feedback\event\course_module_viewed::create_from_record($this->feedback, $this->cm, $this->cm->get_course());
        $event->trigger();
    }
    ...
    /**
     * Process a page jump via the mod_bycs_feedback_complete_form.
     *
    ...
    public function process_page($gopage, $gopreviouspage = false) {
        ...
        $this->form = new mod_bycs_feedback_complete_form(mod_bycs_feedback_complete_form::MODE_COMPLETE,
            $this, 'feedback_complete_form', array('gopage' => $gopage));

        if ($this->form->is_cancelled()) {
            // Form was cancelled - return to the course page.
            $urltogo = new moodle_url('/mod/bycs_feedback/view.php', ['id' => $this->get_cm()->id]);
