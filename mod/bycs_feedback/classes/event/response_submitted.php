...
/**
 * The mod_bycs_feedback response submitted event.
 *
...
/**
 * The mod_bycs_feedback response submitted event class.
 *
...
class response_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventresponsesubmitted', 'mod_bycs_feedback');
    }
    ...
    public function get_url() {
        if ($this->anonymous) {
            return new \moodle_url('/mod/bycs_feedback/show_entries.php', array('id' => $this->other['cmid'],
