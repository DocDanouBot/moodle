...
/**
 * The mod_bycs_feedback response deleted event.
 *
...
/**
 * The mod_bycs_feedback response deleted event class.
 *
...
class response_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventresponsedeleted', 'mod_bycs_feedback');
    }
