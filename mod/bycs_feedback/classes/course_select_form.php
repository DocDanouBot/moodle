...
/**
 * Contains class mod_bycs_feedback_course_map_form
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_bycs_feedback_course_select_form extends moodleform {
    /** @var moodle_url */
    protected $action;
    /** @var mod_bycs_feedback_structure $feedbackstructure */
     ...
     * @param bool $editable
     */
    public function __construct($action, mod_bycs_feedback_structure $feedbackstructure, $editable = true) {
