...
$url = new moodle_url('/mod/bycs_feedback/analysis_course.php', array('id'=>$id));
...
$feedbackstructure = new mod_bycs_feedback_structure($feedback, $PAGE->cm, $courseid);

// Process course select form.
$courseselectform = new mod_bycs_feedback_course_select_form($url, $feedbackstructure);
...
if (has_capability('mod/feedback:viewreports', $context) && $feedbackstructure->get_items()) {
    ...
    $aurl = new moodle_url('/mod/bycs_feedback/analysis_to_excel.php',
...
// Show the summary.
$summary = new mod_bycs_feedback\output\summary($feedbackstructure);
