...
/**
 * The mod_bycs_feedback_use_templ_form
 *
 * @deprecated since 4.0. New dynamic forms have been created instead.
 */
class mod_bycs_feedback_use_templ_form extends moodleform {
    public function __construct($action = null, $customdata = null, $method = 'post', $target = '',
        ...
        debugging('Class mod_bycs_feedback_use_templ_form is deprecated. Replaced with dynamic forms.', DEBUG_DEVELOPER);
