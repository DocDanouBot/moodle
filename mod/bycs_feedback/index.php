...
$url = new moodle_url('/mod/bycs_feedback/index.php', array('id'=>$id));
...
$event = \mod_bycs_feedback\event\course_module_instance_list_viewed::create(array('context' => $context));
...
foreach ($feedbacks as $feedback) {
    ...
    $viewurl = new moodle_url('/mod/bycs_feedback/view.php', array('id'=>$feedback->coursemodule));
