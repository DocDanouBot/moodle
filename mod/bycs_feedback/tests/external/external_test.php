...
namespace mod_bycs_feedback\external;

use core_external\external_api;
use externallib_advanced_testcase;
use feedback_item_multichoice;
use mod_bycs_feedback_external;
...
require_once($CFG->dirroot . '/mod/bycs_feedback/lib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 3.3
 * @covers     \mod_bycs_feedback_external
 */
class external_test extends externallib_advanced_testcase {
    ...
    public function populate_feedback($feedback, $pagescount = 1) {
        $feedbackgenerator = $this->getDataGenerator()->get_plugin_generator('mod_bycs_feedback');
        $itemscreated = [];
    ...
    /**
     * Test test_mod_bycs_feedback_get_feedbacks_by_courses
     */
    public function test_mod_bycs_feedback_get_feedbacks_by_courses() {
        ...
        $returndescription = mod_bycs_feedback_external::get_feedbacks_by_courses_returns();
        ...
        $result = mod_bycs_feedback_external::get_feedbacks_by_courses(array($course2->id, $this->course->id));
        ...
        $result = mod_bycs_feedback_external::get_feedbacks_by_courses();
        $result = external_api::clean_returnvalue($returndescription, $result);
        $this->assertEquals($expectedfeedbacks, $result['feedbacks']);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_bycs_feedback_external::get_feedbacks_by_courses(array($course2->id));
        ...
        $result = mod_bycs_feedback_external::get_feedbacks_by_courses(array($this->course->id));
        $result = external_api::clean_returnvalue($returndescription, $result);
        $this->assertEquals($expectedfeedbacks, $result['feedbacks']);
    }
    ...
    public function test_get_feedback_access_information_student() {
        ...
        self::setUser($this->student);
        $result = mod_bycs_feedback_external::get_feedback_access_information($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_feedback_access_information_returns(), $result);
    ...
    public function test_view_feedback_invalid_id() {
        ...
        mod_bycs_feedback_external::view_feedback(0);
    }
    /**
    ...
    public function test_view_feedback() {
        ...
        $result = mod_bycs_feedback_external::view_feedback($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::view_feedback_returns(), $result);
        $events = $sink->get_events();
        $this->assertCount(1, $events);
        $event = array_shift($events);
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\mod_bycs_feedback\event\course_module_viewed', $event);
        $this->assertEquals($this->context, $event->get_context());
        $moodledata = new \moodle_url('/mod/bycs_feedback/view.php', array('id' => $this->cm->id));
    ...
    public function test_get_current_completed_tmp() {
        ...
        $result = mod_bycs_feedback_external::get_current_completed_tmp($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_current_completed_tmp_returns(), $result);
    ...
    public function test_get_items() {
        ...
        $result = mod_bycs_feedback_external::get_items($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_items_returns(), $result);
    ...
    public function test_get_items_validation(string $role, array $info, ?string $warning): void {
        ...
        if (!array_key_exists('empty', $info) || !$info['empty']) {
            $empty = false;
            /** @var \mod_bycs_feedback_generator $feedbackgenerator */
            $feedbackgenerator = $this->getDataGenerator()->get_plugin_generator('mod_bycs_feedback');
        ...
        $result = mod_bycs_feedback_external::get_items($feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_items_returns(), $result);
        if ($warning) {
    ...
    public function test_launch_feedback() {
        ...
        $result = mod_bycs_feedback_external::launch_feedback($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::launch_feedback_returns(), $result);
    ...
    public function test_get_page_items() {
        ...
        // Retrieve first page.
        $result = mod_bycs_feedback_external::get_page_items($this->feedback->id, 0);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_page_items_returns(), $result);
        $this->assertCount(3, $result['items']);    // The first page has 3 items.
        $this->assertTrue($result['hasnextpage']);
        $this->assertFalse($result['hasprevpage']);

        // Retrieve second page.
        $result = mod_bycs_feedback_external::get_page_items($this->feedback->id, 1);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_page_items_returns(), $result);
    ...
    public function test_get_page_items_validation(string $role, array $info, ?string $warning): void {
        ...
        $result = mod_bycs_feedback_external::get_page_items($feedback->id, 0);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_items_returns(), $result);
        if ($warning) {
            $this->assertEmpty($result['items']);
            $this->assertCount(1, $result['warnings']);
    ...
    public function test_process_page() {
        ...
        $result = mod_bycs_feedback_external::process_page($this->feedback->id, 0, $firstpagedata);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::process_page_returns(), $result);
        ...
        $result = mod_bycs_feedback_external::process_page($this->feedback->id, 1, $secondpagedata, true);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::process_page_returns(), $result);
        $this->assertFalse($result['completed']);
        ...
        $secondpagedata = [$data[2], $data[3], $data[4], $data[5], $data[6]];
        $result = mod_bycs_feedback_external::process_page($this->feedback->id, 1, $secondpagedata);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::process_page_returns(), $result);
    ...
    public function test_process_page_site_feedback() {
        ...
        // Process first page.
        $firstpagedata = [$data[0], $data[1]];
        $result = mod_bycs_feedback_external::process_page($this->feedback->id, 0, $firstpagedata, false, $this->course->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::process_page_returns(), $result);
        $this->assertEquals(1, $result['jumpto']);
        $this->assertFalse($result['completed']);
        ...
        $data[2]['value'] = 2; // 2 is value of the option 'b';
        $secondpagedata = [$data[2], $data[3], $data[4], $data[5], $data[6]];
        $result = mod_bycs_feedback_external::process_page($this->feedback->id, 1, $secondpagedata, false, $this->course->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::process_page_returns(), $result);
        $this->assertTrue($result['completed']);
        $this->assertTrue(strpos($result['completionpagecontents'], $pagecontents) !== false);
        // Check all the items were saved.
    ...
    public function test_get_analysis() {
        ...
        $result = mod_bycs_feedback_external::process_page($this->feedback->id, 0, $pagedata);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::process_page_returns(), $result);
        $this->assertTrue($result['completed']);

        // Retrieve analysis.
        $this->setUser($this->teacher);
        $result = mod_bycs_feedback_external::get_analysis($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_analysis_returns(), $result);
    ...
    public function test_get_unfinished_responses() {
        ...
        $result = mod_bycs_feedback_external::get_unfinished_responses($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_unfinished_responses_returns(), $result);
    ...
    public function test_get_finished_responses() {
        ...
        $result = mod_bycs_feedback_external::get_finished_responses($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_finished_responses_returns(), $result);
        // Check that ids and responses match.
        foreach ($result['responses'] as $r) {
            if ($r['item'] == $numericitem->id) {
                $this->assertEquals(5, $r['value']);
    ...
    public function test_get_non_respondents_no_permissions() {
        $this->setUser($this->student);
        $this->expectException(moodle_exception::class);
        mod_bycs_feedback_external::get_non_respondents($this->feedback->id);
    }
    ...
    public function test_get_non_respondents() {
        ...
        $this->setUser($this->teacher);
        $result = mod_bycs_feedback_external::get_non_respondents($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_non_respondents_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        // Test pagination.
        $result = mod_bycs_feedback_external::get_non_respondents($this->feedback->id, 0, 'lastaccess', 0, 1);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_non_respondents_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(1, $result['users']);
    }
    ...
    protected function complete_basic_feedback() {
        ...
        // Create a very simple feedback.
        $feedbackgenerator = $generator->get_plugin_generator('mod_bycs_feedback');
        $numericitem = $feedbackgenerator->create_item_numeric($this->feedback);
        $textfielditem = $feedbackgenerator->create_item_textfield($this->feedback);
    ...
    public function test_get_responses_analysis_anonymous() {
        ...
        $this->setUser($this->teacher);
        $result = mod_bycs_feedback_external::get_responses_analysis($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_responses_analysis_returns(), $result);
        $this->assertCount(0, $result['warnings']);
    ...
    public function test_get_last_completed_anonymous_not_completed() {
        ...
        $this->expectExceptionMessage(get_string('anonymous', 'feedback'));
        $this->expectException(moodle_exception::class);
        mod_bycs_feedback_external::get_last_completed($this->feedback->id);
    }
    ...
    public function test_get_last_completed_not_anonymous_completed() {
        ...
        // Test user with full capabilities.
        $this->setUser($this->student);
        $result = mod_bycs_feedback_external::get_last_completed($this->feedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_last_completed_returns(), $result);
    ...
    public function test_get_feedback_access_information_for_site_feedback() {
        ...
        $result = mod_bycs_feedback_external::get_feedback_access_information($sitefeedback->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_feedback_access_information_returns(), $result);
        $this->assertTrue($result['cancomplete']);
        $this->assertTrue($result['cansubmit']);

        // Access the site feedback via course where I'm enrolled.
        $result = mod_bycs_feedback_external::get_feedback_access_information($sitefeedback->id, $this->course->id);
        $result = external_api::clean_returnvalue(mod_bycs_feedback_external::get_feedback_access_information_returns(), $result);
        $this->assertTrue($result['cancomplete']);
        $this->assertTrue($result['cansubmit']);
        ...
        $this->expectException(moodle_exception::class);
        mod_bycs_feedback_external::get_feedback_access_information($sitefeedback->id, $othercourse->id);
    }
    ...
    public function test_get_feedback_access_information_for_site_feedback_mapped() {
        ...
        $this->expectException(moodle_exception::class);
        $this->expectExceptionMessage(get_string('cannotaccess', 'mod_bycs_feedback'));
        mod_bycs_feedback_external::get_feedback_access_information($sitefeedback->id, $othercourse->id);
    }
}
