 ...
 */
namespace mod_bycs_feedback\privacy;
...
use mod_bycs_feedback\privacy\provider;
...
class provider_test extends provider_testcase {
    ...
    public function test_get_contexts_for_userid() {
        ...
        $fg = $dg->get_plugin_generator('mod_bycs_feedback');
    ...
    public function test_delete_data_for_user() {
        ...
        $appctx = new approved_contextlist($u1, 'mod_bycs_feedback', [
    ...
    public function test_delete_data_for_users() {
        ...
        $approveduserlist = new approved_userlist($context0, 'mod_bycs_feedback', [$u1->id]);
        ...
        $approveduserlist = new approved_userlist($context1, 'mod_bycs_feedback', [$u1->id, $u2->id]);
        provider::delete_data_for_users($approveduserlist);
    ...
    protected function create_submission_with_answers($feedback, $user, $answers, $submissioncount = 1) {
        ...
        $feedbackcompletion = new \mod_bycs_feedback_completion($feedback, $cm, $feedback->course, false, null, null, $user->id);
