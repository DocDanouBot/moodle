...
namespace mod_bycs_feedback\event;

/**
 * Class mod_bycs_feedback_events_testcase
 *
...
class events_test extends \advanced_testcase {
    ...
    public function test_response_deleted_event() {
        ...
        // Validate event data.
        $this->assertInstanceOf('\mod_bycs_feedback\event\response_deleted', $event);
    ...
    public function test_response_deleted_event_exceptions() {
        ...
        try {
            \mod_bycs_feedback\event\response_submitted::create(array(
                'context'  => $context,
                'objectid' => $this->eventfeedbackcompleted->id,
                'relateduserid' => 2,
            ));
            $this->fail("Event validation should not allow \\mod_bycs_feedback\\event\\response_deleted to be triggered without
                    other['anonymous']");
    ...
    public function test_response_submitted_event() {
        ...
        $this->assertInstanceOf('\mod_bycs_feedback\event\response_submitted', $event);
