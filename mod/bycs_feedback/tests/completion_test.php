...
global $CFG;
require_once($CFG->dirroot . '/mod/bycs_feedback/classes/completion.php');
...
class completion_test extends \advanced_testcase {
     ...
     * @param mod_bycs_feedback_completion $completion
     * @return int number of pages with at least one visible item.
     */
    private function get_number_of_visible_pages(mod_bycs_feedback_completion $completion) {
    ...
    public function test_get_pages() {
        ...
        $completion = new mod_bycs_feedback_completion($feedback, $cm, $course,
            false, null, $user1->id);
        ...
        $completion2 = new mod_bycs_feedback_completion($feedback, $cm, $course,
            false, null, $user2->id);
