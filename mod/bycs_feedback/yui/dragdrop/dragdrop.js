YUI.add('moodle-mod_bycs_feedback-dragdrop', function(Y) {
    var DRAGDROPNAME = 'mod_bycs_feedback_dragdrop';
    var CSS = {
    ...
    Y.extend(DRAGDROP, M.core.dragdrop, {
        ...
        save_item_order : function(cmid, itemorder, spinner) {
            ...
            Y.io(M.cfg.wwwroot + '/mod/bycs_feedback/ajax.php', {
    ...
    M.mod_bycs_feedback = M.mod_bycs_feedback || {};
    M.mod_bycs_feedback.init_dragdrop = function(params) {
