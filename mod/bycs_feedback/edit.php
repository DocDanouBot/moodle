...
$feedbackstructure = new mod_bycs_feedback_structure($feedback, $cm);
$url = new moodle_url('/mod/bycs_feedback/edit.php', ['id' => $cm->id]);
...
$actionbar = new \mod_bycs_feedback\output\edit_action_bar($cm->id, $url, $lastposition);
...
if (count($feedbackitems) > 1) {
    ...
    $PAGE->requires->yui_module('moodle-mod_bycs_feedback-dragdrop', 'M.mod_bycs_feedback.init_dragdrop',
...
$form = new mod_bycs_feedback_complete_form(mod_bycs_feedback_complete_form::MODE_EDIT,
