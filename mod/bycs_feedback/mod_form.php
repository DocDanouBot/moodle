...
class mod_bycs_feedback_mod_form extends moodleform_mod {
    ...
    public function data_preprocessing(&$default_values) {
        ...
        if ($this->current->instance) {
            ...
            $default_values['page_after_submit_editor']['text'] =
                                    ...
                                    'mod_bycs_feedback', 'page_after_submit', false,
                                    $editoroptions,
            ...
            file_prepare_draft_area($draftitemid, null, 'mod_bycs_feedback', 'page_after_submit', false);
            $default_values['page_after_submit_editor']['text'] = '';
