...
abstract class feedback_item_base {
     ...
     * @param mixed $value element from mod_bycs_feedback_complete_form::get_data() with the name $item->typ.'_'.$item->id
     * @return string
     */
     ...
     *
     * @param stdClass $item
     * @param mod_bycs_feedback_complete_form $form
     */
    ...
    public function edit_actions($item, $feedback, $cm) {
        ...
        $actions['update'] = new action_menu_link_secondary(
            new moodle_url('/mod/bycs_feedback/edit_item.php', array('id' => $item->id)),
        ...
        if ($this->can_switch_require()) {
            ...
            $actions['required'] = new action_menu_link_secondary(
                new moodle_url('/mod/bycs_feedback/edit.php', array('id' => $cm->id,
        ...
        $actions['delete'] = new action_menu_link_secondary(
            new moodle_url('/mod/bycs_feedback/edit.php', array('id' => $cm->id, 'deleteitem' => $item->id, 'sesskey' => sesskey())),
