...
$url = new moodle_url('/mod/bycs_feedback/mapcourse.php', array('id'=>$id));
$PAGE->set_url($url);
...
$form = new mod_bycs_feedback_course_map_form();
$form->set_data(array('id' => $cm->id, 'mappedcourses' => $coursemap));
$mainurl = new moodle_url('/mod/bycs_feedback/view.php', ['id' => $id]);
