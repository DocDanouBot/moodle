...
require_once($CFG->dirroot . '/mod/bycs_feedback/backup/moodle2/backup_feedback_stepslib.php');
require_once($CFG->dirroot . '/mod/bycs_feedback/backup/moodle2/backup_feedback_settingslib.php');
