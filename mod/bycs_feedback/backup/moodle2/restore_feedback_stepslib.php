...
class restore_feedback_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function after_execute() {
        ...
        $this->add_related_files('mod_bycs_feedback', 'intro', null);
        $this->add_related_files('mod_bycs_feedback', 'page_after_submit', null);
        $this->add_related_files('mod_bycs_feedback', 'item', 'feedback_item');
