...
class backup_feedback_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $feedback->annotate_files('mod_bycs_feedback', 'intro', null); // This file area hasn't itemid
        $feedback->annotate_files('mod_bycs_feedback', 'page_after_submit', null); // This file area hasn't itemid

        $item->annotate_files('mod_bycs_feedback', 'item', 'id');
