...
require_once($CFG->dirroot . '/mod/bycs_feedback/backup/moodle2/restore_feedback_stepslib.php'); // Because it exists (must)
...
class restore_feedback_activity_task extends restore_activity_task {
    ...
    public static function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('FEEDBACKINDEX', '/mod/bycs_feedback/index.php?id=$1', 'course');
        $rules[] = new restore_decode_rule('FEEDBACKVIEWBYID', '/mod/bycs_feedback/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('FEEDBACKANALYSISBYID', '/mod/bycs_feedback/analysis.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('FEEDBACKSHOWENTRIESBYID', '/mod/bycs_feedback/show_entries.php?id=$1', 'course_module');
