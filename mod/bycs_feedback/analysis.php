...
$url = new moodle_url('/mod/bycs_feedback/analysis.php', array('id'=>$id));
$PAGE->set_url($url);
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('analysis', 'mod_bycs_feedback'), 3);
...
if (has_capability('mod/feedback:viewreports', $context) && $feedbackstructure->get_items()) {
    ...
    $aurl = new moodle_url('/mod/bycs_feedback/analysis_to_excel.php', ['sesskey' => sesskey(), 'id' => $id]);
    echo $OUTPUT->single_button($aurl, get_string('export_to_excel', 'feedback'));
    echo $OUTPUT->container_end();
}

// Show the summary.
$summary = new mod_bycs_feedback\output\summary($feedbackstructure, $mygroupid);
