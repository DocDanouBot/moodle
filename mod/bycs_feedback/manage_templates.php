...
$url = new moodle_url('/mod/bycs_feedback/manage_templates.php', $params);
if ($mode == 'manage') {
    navigation_node::override_active_url($url);
} else {
    navigation_node::override_active_url(new moodle_url('/mod/bycs_feedback/view.php', $params));
}

$PAGE->set_url($url);
$actionbar = new \mod_bycs_feedback\output\edit_action_bar($cm->id, $url);
...
if ($templateid) {
    ...
    $successurl = new moodle_url('/mod/bycs_feedback/manage_templates.php', ['id' => $id]);
...
echo $OUTPUT->heading(get_string('templates', 'mod_bycs_feedback'), 3);
...
$baseurl = new moodle_url('/mod/bycs_feedback/use_templ.php', $params);
$tablecourse = new mod_bycs_feedback_templates_table('feedback_template_course_table', $baseurl, $mode);
...
$tablepublic = new mod_bycs_feedback_templates_table('feedback_template_public_table', $baseurl, $mode);
